...
# The internal PMIC (PY32L020) on M5StickS3 is connected to GPIO 11 (SDA) and GPIO 12 (SCL).
try:
    internal_i2c = I2C(0, sda=Pin(11), scl=Pin(12), freq=100000)
...
print("RawVal, Voltage(mV), Skin_Resistance(kOhm)")
...
while True:
    try:
        ...
        print("Raw: {:4.1f} | Voltage: {:.2f} mV | Resistance: {} | Samples: {}".format(raw_avg, voltage_mv, res_str, count))
